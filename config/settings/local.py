...
CONNECT_REGION = env('CONNECT_REGION')
CONNECT_NOTIFY_FLOW_ID = env('CONNECT_NOTIFY_FLOW_ID')
CONNECT_NOTIFY_INSTANCE_ID = env('CONNECT_NOTIFY_INSTANCE_ID')
CONNECT_PHONE_NUMBER = env('CONNECT_PHONE_NUMBER')
